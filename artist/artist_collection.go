...
// CurrencyBalance is a free data retrieval call binding the contract method 0x5c75347a.
//
// Solidity: function currencyBalance() view returns(uint256)
func (_Artist *ArtistCaller) CurrencyBalance(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Artist.contract.Call(opts, &out, "currencyBalance")
...
//
// Solidity: function currencyBalance() view returns(uint256)
func (_Artist *ArtistSession) CurrencyBalance() (*big.Int, error) {
	return _Artist.Contract.CurrencyBalance(&_Artist.CallOpts)
}

// CurrencyBalance is a free data retrieval call binding the contract method 0x5c75347a.
//
// Solidity: function currencyBalance() view returns(uint256)
func (_Artist *ArtistCallerSession) CurrencyBalance() (*big.Int, error) {
	return _Artist.Contract.CurrencyBalance(&_Artist.CallOpts)
}
...
// SetPriceBatch is a paid mutator transaction binding the contract method 0x86f05f1d.
//
// Solidity: function setPriceBatch(uint256[] _ids, uint256[] _prices) returns()
func (_Artist *ArtistTransactor) SetPriceBatch(opts *bind.TransactOpts, _ids []*big.Int, _prices []*big.Int) (*types.Transaction, error) {
	return _Artist.contract.Transact(opts, "setPriceBatch", _ids, _prices)
}

// SetPriceBatch is a paid mutator transaction binding the contract method 0x86f05f1d.
//
// Solidity: function setPriceBatch(uint256[] _ids, uint256[] _prices) returns()
func (_Artist *ArtistSession) SetPriceBatch(_ids []*big.Int, _prices []*big.Int) (*types.Transaction, error) {
	return _Artist.Contract.SetPriceBatch(&_Artist.TransactOpts, _ids, _prices)
}

// SetPriceBatch is a paid mutator transaction binding the contract method 0x86f05f1d.
//
// Solidity: function setPriceBatch(uint256[] _ids, uint256[] _prices) returns()
func (_Artist *ArtistTransactorSession) SetPriceBatch(_ids []*big.Int, _prices []*big.Int) (*types.Transaction, error) {
	return _Artist.Contract.SetPriceBatch(&_Artist.TransactOpts, _ids, _prices)
}
